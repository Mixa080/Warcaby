...
public class GameManager {
    ...
    public List<Move> getValidMoves() {
        if (multiJumpPiece != null) {
            // Blokada ruchu: wymuszamy kolejne bicie tą samą pionką
    ...
    public boolean applyMove(Move move) {
        ...
        if (validMoves.contains(move)) {
            ...
            // Sprawdzenie czy możliwe jest wielokrotne bicie
            ...
            if (isJump && !becameKing) {
                ...
                if (!nextJumps.isEmpty()) {
                    ...
                    multiJumpPiece = new int[]{move.toRow, move.toCol}; // Zapisujemy pozycję bijącej pionki
                }
            }

            // Zmiana tury tylko, gdy nie ma kolejnego bicia
